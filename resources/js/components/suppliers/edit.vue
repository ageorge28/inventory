                  ...
                  <form class="user" @submit.prevent="supplierUpdate" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <div class="form-row">
                        ...
                        <div class="col-6">
                            <input type="text" class="form-control" id="shopname" name="shopname" v-model="form.shopname" placeholder="Enter Your Shop Name" />
...
export default {
  ...
  created() {
      ...
      axios.get('/inventory/inventory/api/suppliers/' + id)
  ...
  methods: {
    supplierUpdate() {
        let id = this.$route.params.id
        axios.put('/inventory/inventory/api/suppliers/' + id, this.form)
        .then( () => {
