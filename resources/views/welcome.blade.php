...
<body id="page-top">
  ...
  <nav id="sidebar" v-show="$route.path === '/' || $route.path === '/register' || $route.path === '/forget' ? false : true " style="display:  none;"> 
   ...
   <router-link class="collapse-item" to="/employees/store">Add Employee</router-link>
...
<li class="nav-item">
   ...
   <router-link class="collapse-item" to="/suppliers/store">Add Suppliers</router-link>
...
<li class="nav-item">
   ...
   <router-link class="collapse-item" to="/categories/store">Add Category</router-link>
...
<li class="nav-item">
   ...
   <router-link class="collapse-item" to="/products/store">Add Product</router-link>
   <router-link class="collapse-item" to="./products">All Product</router-link>
...
<li class="nav-item">
   ...
   <router-link class="collapse-item" to="/expenses/store">Add Expense</router-link>
   <router-link class="collapse-item" to="/expenses">All Expense</router-link>
...
<li class="nav-item">
   ...
   <router-link class="collapse-item" to="/customers/store">Add Customer</router-link>
...
<li class="nav-item">
   ...
   <router-link class="collapse-item" to="/salaries/store">Add Salary</router-link>
...
<li class="nav-item">
   ...
   <router-link class="collapse-item" to="/orders/today">Today Order</router-link>
